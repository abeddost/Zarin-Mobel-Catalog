...
export default function Footer() {
  return (
    <footer id="kontakt" className="bg-[#080604] border-t border-white/8 px-6 py-14">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              <span className="text-[#c9a96e] font-light tracking-[0.2em] text-sm uppercase ml-2">Möbelhaus</span>
            </div>
          </div>
          <p className="text-white/25 text-xs tracking-[0.15em] font-[Cormorant_Garamond] italic text-lg leading-snug">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-[#c9a96e] text-[10px] tracking-[0.4em] uppercase mb-2">Adresse</p>
        ...
        {/* Contact */}
        <div className="flex flex-col gap-2">
          <p className="text-[#c9a96e] text-[10px] tracking-[0.4em] uppercase mb-2">Kontakt</p>
          <a
            href="tel:+4915756345284"
            className="flex items-center gap-3 text-white/50 hover:text-[#c9a96e] transition-colors duration-300 text-sm py-1"
          >
